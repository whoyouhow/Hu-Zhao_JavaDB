...
import _3_indexing.BPlusTree;
import _3_indexing.Entry;
import _3_indexing.InnerNode;
import _3_indexing.LeafNode;
import _3_indexing.Node;
...
public class BPlusTreeTest {
	...
	public void testComplexInsert() {
		...
		bt.insert(new Entry(new IntField(9), 0));
//		if(root.isLeafNode()) {
//			System.out.println(((LeafNode)root).getKeys());
//		}
//		else{
//			System.out.println(((InnerNode)root).getKeys());
//		}
		bt.printTree();
		...
		bt.printTree();
//		LeafNode org = ((LeafNode)(        ((InnerNode)(   ((InnerNode)bt.getRoot()).getChildren().get(0) )).getChildren().get(2)      ));
//		System.out.println(    org.getLeftSibling().getKeys()         );
